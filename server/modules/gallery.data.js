const galleryItems = [
    { id: 1, title: 'Happy Dogs', description: 'Murph and Bon in the wild', path: 'images/mbfieldrun.JPG', likes: 0},
    ...
    { id: 4, title: 'Murph', description: 'A Beautiful Boy', path: 'images/lilb.JPG', likes: 0}
];
